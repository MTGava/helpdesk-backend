...
import com.gavag.helpdesk.domain.dtos.ChamadoDTO;
import com.gavag.helpdesk.services.ChamadoService;
...
public class ChamadoResource {
    ...
    public ResponseEntity<ChamadoDTO> update(@PathVariable Integer id, @Valid @RequestBody ChamadoDTO objDTO) {
        Chamado old = service.update(id, objDTO);
        return ResponseEntity.ok(new ChamadoDTO(old));
    }
}
